...
% global不能传矩阵
 ...
 switch(action)
    ...
    case 'start',
        ...
        dlmwrite('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IXT.txt', -10, 'delimiter', '\t', 'precision', 6);
        dlmwrite('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IYT.txt', -10, 'delimiter', '\t', 'precision', 6);
        %%滑鼠按钮被按下时的反应指令
    case 'down',
        if strcmp(get(FigHandle, 'SelectionType'), 'normal')    %如果是左键
            ...
            dlmwrite('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IXT.txt', InitialX, '-append', 'delimiter', '\t', 'precision', 6);
            dlmwrite('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IYT.txt', InitialY, '-append', 'delimiter', '\t', 'precision', 6);
        ...
        elseif strcmp(get(FigHandle, 'SelectionType'), 'alt')   % 如果是右键
            ...
            ImageX = importdata('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IXT.txt');
            ImageY = importdata('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IYT.txt');
            ...
            delete('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IXT.txt');%每次识别完要先删除，否则是根据上面的'-append'写入
            delete('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IYT.txt');
            bayesBinaryTest(InputImage); %调用手写体识别函数
            imwrite(InputImage,'C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\图片.bmp');
        end
    %%滑鼠移动时的反应指令
    case 'move',
        CurPiont = get(gca, 'CurrentPoint');
        ...
        dlmwrite('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IXT.txt', ImageX, '-append', 'delimiter', '\t', 'precision', 6);
        dlmwrite('C:\Users\histan\Desktop\贝叶斯手写汉字识别\程序\IYT.txt', ImageY, '-append', 'delimiter', '\t', 'precision', 6);
        InitialX = X;       %记住当前点坐标
        InitialY = Y;       %记住当前点坐标
    %%滑鼠按钮被释放时的反应指令
    case 'up',
